...
public class SpiderThread extends ScanThread implements SpiderListener {
    ...
    private void runScan() {
        ...
        spiderDone = 0;
        started = new Date();
        log.info("Starting spidering scan on " + site + " at " + started);
        startSpider();
        this.isAlive = true;
    }
    ...
    public void spiderComplete(boolean successful) {
        ...
        log.info("Spider scanning complete: " + successful + " on " + site + " at " + finished);
    ...
    /**
     * Returns the time taken in milliseconds. This will be total time taken in the scan has
